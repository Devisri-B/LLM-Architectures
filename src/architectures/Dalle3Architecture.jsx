...
const initialNodes = [
  { id: '1', position: { x: 250, y: 0 }, data: { label: 'User Prompt' }, style: { background: '#fff', border: '1px solid #333' } },
  { id: '2', position: { x: 250, y: 80 }, data: { label: 'Synthetic Captioner\n[Rewrites/Expands Prompt]' }, style: { background: '#fff3e0', border: '1px solid #ef6c00' } },
  { id: '3', position: { x: 250, y: 160 }, data: { label: 'Text Encoder (Transformer)\n[Generates Embeddings]' }, style: { background: '#e3f2fd', border: '1px solid #2196f3' } },
  ...
  { id: '4b', position: { x: 50, y: 90 }, parentNode: '4', data: { label: 'Cross-Attention\n(Image Latents <-> Text Emb)' }, style: { background: '#e1bee7', border: '1px solid #8e24aa', width: 250 } },
...
const initialEdges = [
  ...
  { id: 'e3-4b', source: '3', target: '4b', label: 'Conditioning' },
