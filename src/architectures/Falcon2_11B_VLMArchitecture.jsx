...
const initialNodes = [
  ...
  { id: '4', position: { x: 100, y: 180 }, data: { label: 'Dynamic Projector\n[Maps Image -> Text Space]' }, style: { background: '#fff9c4', border: '2px solid #fbc02d', width: 200 } },

  // LLM Backbone
  { id: '5', position: { x: 250, y: 300 }, data: { label: 'Falcon 2 11B Backbone' }, style: { width: 400, height: 150, background: 'rgba(224, 247, 250, 0.5)', border: '1px dashed #00acc1' }, type: 'group' },
