...
const initialNodes = [
  ...
  { id: '4b', position: { x: 40, y: 95 }, parentNode: '4', data: { label: 'Self-Attention (Spatial + Temporal)' }, style: { background: '#e0f7fa', border: '1px solid #00bcd4', fontSize: '11px', width: 280 } },
  { id: '4c', position: { x: 40, y: 170 }, parentNode: '4', data: { label: 'Pointwise Feedforward' }, style: { background: '#fff', fontSize: '11px', width: 280 } },
  { id: '4d', position: { x: 40, y: 245 }, parentNode: '4', data: { label: 'Zero-Scale Initialization' }, style: { background: '#ffebee', fontSize: '11px', width: 280 } },

  // Output
  { id: '5', position: { x: 250, y: 710 }, data: { label: 'VAE Decoder\n[Latent to Pixel Space]' }, style: { background: '#fff3e0', border: '1px solid #f57c00' } },
  { id: '6', position: { x: 250, y: 810 }, data: { label: 'Output: High-Fidelity Video' }, style: { background: '#ccffcc', border: '1px solid #006400', fontWeight: 'bold' } },
];
